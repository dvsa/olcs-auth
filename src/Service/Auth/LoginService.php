...
class LoginService implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $this->lastLoginService = $serviceLocator->get('Common\User\LastLoginService');
     ...
     * @return Response
     */
    public function login($token, $authId, Response $response)
    {
        ...
        $this->lastLoginService->updateLastLogin($authId);
